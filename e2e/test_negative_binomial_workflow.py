"""
End-to-end test: federated Negative Binomial Regression workflow.
"""
import re
import time
...
PROJECT_NAME = "e2e-nb-project"

TASKS_JSON = (
    '[{"seq": 1, "model": "NegativeBinomialRegression",'
...
def test_negative_binomial_workflow(pages, base_a, base_b, base_c, fixtures_dir):
    """Full federated Negative Binomial Regression workflow."""
    ...
    page_a.fill('textarea[name="description"]', "E2E NB test")
