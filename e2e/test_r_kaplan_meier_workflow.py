"""
End-to-end test: federated R Kaplan-Meier workflow.
"""
import re
import time
...
PROJECT_NAME = "e2e-r-km-project"

TASKS_JSON = (
    '[{"seq": 1, "model": "RKaplanMeier",'
...
def test_r_kaplan_meier_workflow(pages, base_a, base_b, base_c, fixtures_dir):
    """Full federated R Kaplan-Meier workflow."""
    ...
    page_a.fill('textarea[name="description"]', "E2E R KM test")
