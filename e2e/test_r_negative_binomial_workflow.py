"""
End-to-end test: federated R Negative Binomial Regression workflow.
"""
import re
import time
...
PROJECT_NAME = "e2e-r-nb-project"

TASKS_JSON = (
    '[{"seq": 1, "model": "RNegativeBinomialRegression",'
...
def test_r_negative_binomial_workflow(pages, base_a, base_b, base_c, fixtures_dir):
    """Full federated R Negative Binomial Regression workflow."""
    ...
    page_a.fill('textarea[name="description"]', "E2E R NB test")
