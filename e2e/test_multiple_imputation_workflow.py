"""
End-to-end test: federated Multiple Imputation (MICE) workflow.

Uses the same 8-step pattern as test_fl_workflow.py but with
MultipleImputation model and data containing missing values.
"""
import re
import time
...
PROJECT_NAME = "e2e-mice-project"

TASKS_JSON = (
    '[{"seq": 1, "model": "MultipleImputation",'
...
def test_multiple_imputation_workflow(pages, base_a, base_b, base_c, fixtures_dir):
    """Full federated Multiple Imputation workflow through the Controller web portal."""
    ...
    page_a.fill('textarea[name="description"]', "E2E MICE test")
