"""
End-to-end test: federated Kaplan-Meier workflow.
"""
import re
import time
...
PROJECT_NAME = "e2e-km-project"

TASKS_JSON = (
    '[{"seq": 1, "model": "KaplanMeier",'
...
def test_kaplan_meier_workflow(pages, base_a, base_b, base_c, fixtures_dir):
    """Full federated Kaplan-Meier workflow."""
    ...
    page_a.fill('textarea[name="description"]', "E2E KM test")
